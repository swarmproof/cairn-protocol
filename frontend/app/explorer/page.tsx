  ...
  return (
    <div className="container py-8">
      ...
      <div className="relative mb-8 p-6 rounded-2xl bg-black/[0.96] border border-slate-800 overflow-hidden">
        <Spotlight className="-top-40 left-0 md:left-20 md:-top-20" fill="rgba(16, 185, 129, 0.12)" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        ...
        <Card className="cursor-pointer hover:border-blue-500/50 transition-colors" onClick={() => setStateFilter(TaskState.RUNNING)}>
          <CardContent className="p-4">
        ...
        <Card className="cursor-pointer hover:border-green-500/50 transition-colors" onClick={() => setStateFilter(TaskState.RESOLVED)}>
          <CardContent className="p-4">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card className="relative overflow-hidden">
            <BorderBeam size={100} duration={12} colorFrom="#10b981" colorTo="#06b6d4" />
            <CardHeader>
